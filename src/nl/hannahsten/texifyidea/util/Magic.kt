...
object Magic {
    ...
    object File {
         ...
         */
        val generatedFileTypes = auxiliaryFileTypes + arrayOf("blg", "dvi", "fdb_latexmk", "ilg", "log", "out.ps", "pdf", "run.xml", "sagetex.sage", "sagetex.scmd", "sagetex.sout", "synctex", "synctex.gz", "synctex(busy)", "upa", "doctest.sage", "xdv")
    }
