...
enum class LatexNoMathCommand(
    ...
    IMPORT("import", "path".asRequired(), RequiredFileArgument("sourcefile", "tex"), dependency = Package.IMPORT),
    ...
    SUBIMPORT("import", "path".asRequired(), RequiredFileArgument("sourcefile", "tex"), dependency = Package.IMPORT),
    SUBITEM("subitem"),
